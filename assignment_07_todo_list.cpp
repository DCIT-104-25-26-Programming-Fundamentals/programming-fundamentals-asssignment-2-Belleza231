// Nane: GUFTY AFUA AHEMAH NTOW
// Student ID: 22461638
// Assignment 7: Todo_List
...
int main() {
    vector<string> tasks; // This stores all our tasks
    int choice;
...
void addTask(vector<string>& tasks) {
    string task;
    cout << "Enter task: ";
    getline(cin, task); // getline lets us type "Buy groceries" with spaces
...
void viewTasks(const vector<string>& tasks) {
    if(tasks.empty()) {
        cout << "Your Tasks: No tasks yet!" << endl;
        return;
    }
